...
function maf_filter_construct_field_header(b,a){var c=$("<li/>",{"class":"filter-input",id:"_filter_cp_"+b}),e=$("<div/>",{"class":"pull-left"}),d=$("<div/>",{"class":"pull-right"}),g=$("<a/>",{href:"#",id:"_filter_remove_"+b,html:"<span class='fa fa-times-2'></span>"}),f=$("<strong/>",{text:a.label});e.append(f);d.append("&nbsp;&nbsp;");d.append(g);c.append(e);c.append(d);return c}
