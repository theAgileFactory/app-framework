...
public interface IDashboardService {
    ...
    /**
     * Creates a new widget from the widget catalog entry and return its unique
     * id as well as its display URL.<br/>
     * This throws an exception of this widget entry is not consistent.
     * 
     * @param dashboardPageId
     *            the id of the dashboard page
     * @param uid
     *            the UID of a user or null (if null the current user is used)
     * @param widgetCatalogEntry
     *            an entry of the widget catalog (list of active and available
     *            widgets)
     * @param widgetTitle
     *            a title for the widget (as displayed in the widget header)
     */
    ...
    /**
     * Delete a new widget from a dashboard page. This throws an exception of
     * this widget entry is not consistent.
     * 
     * @param dashboardPageId
     *            the id of the dashboard page
     * @param uid
     *            the UID of a user or null (if null the current user is used)
     * @param widgetId
     *            the unique id of the widget to be deleted
     */
    ...
    /**
     * Return the DashboardPage configuration for the specified id and the
     * specified user.<br/>
     * The code must check if the specified dashboard page belongs to the
     * specified user. This is a tuple:
     * <ul>
     * <li>[1] the page title/name</li>
     * <li>[2] true if the page is the user home page (default displayed)</li>
     ...
     *            the UID of a user or null (if null the current user is used)
     * @param name
     *            the name of the page to be updated
     * @throws DashboardException
     */
     ...
     * @param isHome
     *            true if the page is the home page of the dashboard
     * @param config
     *            the page configuration
    ...
    /**
     * Return true if the specified widget exists in the system for the
     * specified user.
     * 
     * @param widgetId
     *            a unique widget id
    ...
    /**
     * A data structure which is to be used to manage a widget catalog entry.
     * <br/>
     * This one contains:
     * <ul>
